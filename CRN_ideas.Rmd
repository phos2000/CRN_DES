...
```{r integrate}
all.files = sapply(67:200, function(x) paste0("~/Documents/GitHub/CRN_DES/output_accre/rrStatinsASCVD-",x,".RData"))
...
save(all_wCRN, all_woCRN, file = "rrStatinsASCVD134.RData")
```
